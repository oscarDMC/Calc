...
public class calcservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //String resultado = "<div>" + a + " + " + b + " = " + calcbean.suma(a, b) + "</div>";

            
            if("Suma".equalsIgnoreCase(action)){
            //out.println("<div style='position: absolute; top: 115px; left: 110px;'>" + a + " + " + b + " = " + calcbean.suma(a, b) + "</div>");
            ...
            //out.println("<div>"  + a + " - " + b + " = " + calcbean.resta(a, b) + "</div>");
            out.println("<div style='position: absolute; top: 115px; left: 110px;'>"); 
            out.println("<img src=\"https://www.supercoloring.com/sites/default/files/styles/coloring_full/public/cif/2022/01/calculator-coloring-page.png\" alt=\"Imagen de ejemplo\">"); 
            out.println("<div style='position: absolute; top: 115px; left: 150px; font-size: 100px;'>"); 
            ...
            //out.println("<h1>"  + a + " ^ " + b + " = " + calcbean.exponente(a, b) + "</h1>");
            out.println("<div style='position: absolute; top: 115px; left: 110px;'>"); 
            out.println("<img src=\"https://www.supercoloring.com/sites/default/files/styles/coloring_full/public/cif/2022/01/calculator-coloring-page.png\" alt=\"Imagen de ejemplo\">"); 
            out.println("<div style='position: absolute; top: 115px; left: 150px; font-size: 100px;'>"); 
            ...
            //out.println("<h1>"  + a + " * " + b + " = " + calcbean.multiplicar(a, b) + "</h1>");
            out.println("<div style='position: absolute; top: 115px; left: 110px;'>"); 
            out.println("<img src=\"https://www.supercoloring.com/sites/default/files/styles/coloring_full/public/cif/2022/01/calculator-coloring-page.png\" alt=\"Imagen de ejemplo\">"); 
            out.println("<div style='position: absolute; top: 115px; left: 150px; font-size: 100px;'>"); 
            ...
            out.println("<img src=\"https://www.supercoloring.com/sites/default/files/styles/coloring_full/public/cif/2022/01/calculator-coloring-page.png\" alt=\"Imagen de ejemplo\">"); 
            out.println("<div style='position: absolute; top: 115px; left: 150px; font-size: 100px;'>"); 
            out.println(a + " / " + b + " = " + calcbean.division(a, b)); 
            out.println("</div>"); 
            out.println("</div>"); 
